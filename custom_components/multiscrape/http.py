...
class HttpWrapper:
    ...
    async def async_request(self, context, method, resource, request_data=None):
        ...
        try:
            ...
            # bit of a hack since httpx also raises an exception for redirects:
            # https://github.com/encode/httpx/blob/c6c8cb1fe2da9380f8046a19cdd5aade586f69c8/CHANGELOG.md#0200-13th-october-2021
