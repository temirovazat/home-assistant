...
class ClimateGroup(ClimateEntity):
    ...
    async def async_update(self):
        ...
        if all_fan_modes:
            ...
            self._fan_mode = Counter(itertools.chain(all_fan_modes)).most_common(1)[0][
                0
            ]
        ...
        if all_swing_modes:
            ...
            self._swing_mode = Counter(itertools.chain(all_swing_modes)).most_common(1)[
                0
            ][0]
        ...
        _LOGGER.debug(
            f"Target temp: {self._target_temp}; Target temp low: \
            {self._target_temp_low}; Target temp high: {self._target_temp_high}; Current temp: {self._current_temp}"
        )
