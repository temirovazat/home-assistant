...
try:
    ...
    log_info(
        logger,
        data,
        "Python Script: {} -> START of action: {}".format(script_name, action),
    )
    ...
    if action == "":
        ...
        if entity_id == "":
            log_error(
                logger,
                "**Required parameter 'entity_id' is missing.**\n\nAction '{}' NOT executed.".format(
                    action.lower()
                ),
            )
        else:
            ...
            if entity is None:
                ...
                if new_state is None or new_state == "":
                    log_error(
                        logger,
                        "**Required parameter 'state' is missing.**\n\nAction '{}' NOT executed.".format(
                            action.lower()
                        ),
                    )
                else:
                    ...
                    log_info(
                        logger,
                        data,
                        "  DONE -> State set for entity '{}'".format(entity_id),
                    )
        ...
        if entity_id == "":
            ...
            if entity is None:
                ...
                if new_attributes is None or new_attributes == "":
                    log_error(
                        logger,
                        "**Required parameter 'attributes' is missing.**\n\nAction '{}' NOT executed.".format(
                            action.lower()
                        ),
                    )
                else:
                    ...
                    log_info(
                        logger,
                        data,
                        "  DONE -> Attributes set for entity '{}'".format(entity_id),
                    )
                    ...
                    if new_attributes is None or new_attributes == "":
                        ...
                        for new_attr in new_attributes:
                            for (
                                k,
                                v,
                            ) in new_attr.items():  # This should iterate just once
                                log_info(
                                    logger,
                                    data,
                                    "  Entity: '{}' -> New attribute '{}': '{}'".format(
                        ...
                        log_info(
                            logger,
                            data,
                            "  DONE -> State & attributes set for entity '{}'".format(
                                entity_id
                            ),
                        )
        ...
        if entity_id == "":
            ...
            if entity is None:
                ...
                if del_attribute == "":
                    log_error(
                        logger,
                        "**Required parameter 'attribute' is missing.**\n\nAction '{}' NOT executed.".format(
                            action.lower()
                        ),
                    )
                else:
                    ...
                    log_info(
                        logger,
                        data,
                        "  DONE -> Attribute '{}' deleted from entity '{}'".format(
                            del_attribute, entity_id
                        ),
                    )
        ...
        log_error(
            ...
            'set_attributes', 'set_state_attributes', 'delete_attribute'.".format(
                action
            ),
        )
    ...
    log_info(
        logger,
        data,
        "Python Script: {} -> END of action: {}".format(script_name, action),
    )
